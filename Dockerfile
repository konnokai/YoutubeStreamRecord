...
FROM jun112561/dotnet_with_yt-dlp:2023.06.22 AS base
WORKDIR /app
...
ENTRYPOINT ["dotnet", "Youtube Stream Record.dll", "sub", "-d", "-s", "-o", "/output", "-t", "/temp_path", "-u", "/unarchived_stream", "-m", "/member_only_stream"]